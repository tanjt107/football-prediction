...
module "bigquery-outputs" {
  ...
  views = {
    ...
    simulation_aco_ko          = file("../../src/bigquery/sql/outputs/simulation_aco_ko.sql")
    simulation_asc_gs          = file("../../src/bigquery/sql/outputs/simulation_asc_gs.sql")
    simulation_asc_ko          = file("../../src/bigquery/sql/outputs/simulation_asc_ko.sql")
    ...
    simulation_copa_gs         = file("../../src/bigquery/sql/outputs/simulation_copa_gs.sql")
    simulation_copa_ko         = file("../../src/bigquery/sql/outputs/simulation_copa_ko.sql")
    ...
    simulation_euro_gs         = file("../../src/bigquery/sql/outputs/simulation_euro_gs.sql")
    simulation_euro_ko         = file("../../src/bigquery/sql/outputs/simulation_euro_ko.sql")
