WITH result AS (
  SELECT
    ...
    COALESCE(positions._1, 0) + COALESCE(positions._2, 0) + COALESCE(positions._3, 0) + COALESCE(positions._4, 0) * 0.25 AS ucl,
    COALESCE(positions._4, 0) * 0.75 + COALESCE(positions._5, 0) AS uel,
